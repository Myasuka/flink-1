...
class DependencyManagerTests(PyFlinkTestCase):
    ...
    def test_constant_consistency(self):
        JDependencyManager = get_gateway().jvm.org.apache.flink.python.PythonDependencyManager
        self.assertEqual(DependencyManager.PYTHON_REQUIREMENTS_CACHE,
                         JDependencyManager.PYTHON_REQUIREMENTS_CACHE)
        self.assertEqual(DependencyManager.PYTHON_REQUIREMENTS_FILE,
                         JDependencyManager.PYTHON_REQUIREMENTS_FILE)
        self.assertEqual(DependencyManager.PYTHON_ARCHIVES_MAP,
                         JDependencyManager.PYTHON_ARCHIVES_MAP)
        self.assertEqual(DependencyManager.PYTHON_FILE_MAP, JDependencyManager.PYTHON_FILE_MAP)
        self.assertEqual(DependencyManager.PYTHON_EXEC, JDependencyManager.PYTHON_EXEC)
