...
class PythonBootTests(PyFlinkTestCase):
    ...
    def test_constant_consistency(self):
        JProcessEnvironmentManager = \
            get_gateway().jvm.org.apache.flink.python.ProcessEnvironmentManager
        from pyflink.fn_execution.boot import (PYTHON_REQUIREMENTS_FILE,
                                               PYTHON_REQUIREMENTS_CACHE,
                                               PYTHON_REQUIREMENTS_DIR_ENV)
        self.assertEqual(PYTHON_REQUIREMENTS_FILE,
                         JProcessEnvironmentManager.PYTHON_REQUIREMENTS_FILE)
        self.assertEqual(PYTHON_REQUIREMENTS_CACHE,
                         JProcessEnvironmentManager.PYTHON_REQUIREMENTS_CACHE)
        self.assertEqual(PYTHON_REQUIREMENTS_DIR_ENV,
                         JProcessEnvironmentManager.PYTHON_REQUIREMENTS_DIR_ENV)
    ...
    def test_set_working_directory(self):
        ...
        self.env[JProcessEnvironmentManager.PYTHON_WORKING_DIR] = self.tmp_dir
        self.env["python"] = sys.executable
        args = [self.runner_path]
