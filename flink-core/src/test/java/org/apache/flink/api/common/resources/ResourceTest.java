...
public class ResourceTest extends TestLogger {
	...
	public void testConstructorValid() {
		...
		assertResourceValueEquals(0.1, v1);

		final Resource v2 = new TestResource(BigDecimal.valueOf(0.1));
		assertResourceValueEquals(0.1, v2);
	}
	...
	public void testMerge() {
		...
		assertResourceValueEquals(0.3, v1.merge(v2));
	}
	...
	public void testSubtract() {
		...
		final Resource v2 = new TestResource(0.1);
		assertResourceValueEquals(0.1, v1.subtract(v2));
	}
	...
	private static void assertResourceValueEquals(final double value, final Resource resource) {
		assertEquals(value, resource.getValue().doubleValue(), 0.000001);
	}
}
