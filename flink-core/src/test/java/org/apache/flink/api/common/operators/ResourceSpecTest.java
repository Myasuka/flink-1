...
public class ResourceSpecTest extends TestLogger {
	...
	public void testMerge() throws Exception {
		...
		assertEquals(2.0, rs3.getCpuCores().getDoubleValue(), 0.000001);
		assertEquals(200, rs3.getTaskHeapMemory().getMebiBytes());
		assertEquals(1.1, rs3.getGPUResource().getDoubleValue(), 0.000001);

		ResourceSpec rs4 = rs1.merge(rs3);
		assertEquals(2.2, rs4.getGPUResource().getDoubleValue(), 0.000001);
	}
	...
	public void testSubtract() {
		...
		assertEquals(0.8, subtracted.getCpuCores().getDoubleValue(), 0.000001);
		assertEquals(0, subtracted.getTaskHeapMemory().getMebiBytes());
		assertEquals(0.6, subtracted.getGPUResource().getDoubleValue(), 0.000001);
	}
