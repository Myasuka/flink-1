...
public class ResourceSpecTest extends TestLogger {
	...
	public void testMerge() throws Exception {
		...
		assertEquals(2.0, rs3.getCpuCores().getValue().doubleValue(), 0.000001);
		assertEquals(200, rs3.getTaskHeapMemory().getMebiBytes());
		assertEquals(1.1, rs3.getGPUResource().getValue().doubleValue(), 0.000001);

		ResourceSpec rs4 = rs1.merge(rs3);
		assertEquals(2.2, rs4.getGPUResource().getValue().doubleValue(), 0.000001);
	}
