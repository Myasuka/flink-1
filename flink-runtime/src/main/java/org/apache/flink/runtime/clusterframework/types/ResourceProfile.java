...
public class ResourceProfile implements Serializable {
	 ...
	 */
	@VisibleForTesting
	public static final ResourceProfile ANY = new ResourceProfile(new AdditiveResourceValue(Double.MAX_VALUE), MemorySize.MAX_VALUE, MemorySize.MAX_VALUE, MemorySize.MAX_VALUE, MemorySize.MAX_VALUE, MemorySize.MAX_VALUE, Collections.emptyMap());
