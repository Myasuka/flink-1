...
public class SlotProfile {
	...
	public static SlotProfile preferredLocality(
		...
		return priorAllocation(resourceProfile, preferredLocations, Collections.emptyList());
	}
	 ...
	 * @return Slot profile with the given resource profile, preferred locations and prior allocations
	 */
	@VisibleForTesting
	public static SlotProfile priorAllocation(
		...
		return priorAllocation(resourceProfile, resourceProfile, preferredLocations, priorAllocations, Collections.emptySet());
	}
